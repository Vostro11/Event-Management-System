...
<div class="row">
  <div class="col-md-6">
    <div class="box box-primary">
      ...
      <div class="box-body">
        <form class="form-horizontal" action="{{url('client/store')}}" method="post">
    {{csrf_field()}}
      
      <div class="form-group{{ $errors->has('client_name') ? ' has-error' : '' }}">
        <label class="control-label col-sm-4" for="client_name">Client Name:</label>
        <div class="col-sm-8">
          <input type="text" name="client_name" value="{{old('client_name')}}" class="form-control" id="client_name" placeholder="Enter client_name" required="">
      ...
      <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-8">
          <input type="text" name="password" value="{{old('password')}}" class="form-control" id="password" placeholder="Enter password" required="">
      ...
      <div class="form-group{{ $errors->has('expire_on') ? ' has-error' : '' }}">
        ...
        <div class="col-sm-8">
          <input type="date" name="expire_on" value="{{old('expire_on')}}" class="form-control" id="expire_on" placeholder="Enter expire_on">
