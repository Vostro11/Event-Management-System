...
class ClientServiceProvider extends ServiceProvider
{
	...
	public function registerStaffRepository() {
		return $this->app->bind(
			'Modules\\Client\\Repositories\\StaffRepository',
			'Modules\\Client\\Repositories\\StaffEloquent'
