...
class EventServiceProvider extends ServiceProvider
{
    ...
    public function boot()
    {
        ...
        $this->registerEventsettingRepository();
        $this->registerEventstaffRepository();
    }
	...
	public function registerEventsettingRepository() {
		return $this->app->bind(
			'Modules\\Event\\Repositories\\EventsettingRepository',
			'Modules\\Event\\Repositories\\EventsettingEloquent'

		);
	}

	public function registerEventstaffRepository() {
		return $this->app->bind(
			'Modules\\Event\\Repositories\\EventstaffRepository',
			'Modules\\Event\\Repositories\\EventstaffEloquent'
