	...
	<div class="row">
		<div class="col-md-6">
			<div class="box box-primary">
				...
				<div class="box-body">
					<form role="form" action="{{url('admin/event/eventsetting/update/'.$eventsetting['id'])}}" method="post" enctype="multipart/form-data">
						{!! csrf_field() !!}
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" class="form-control" id="call_partner_as" placeholder="Enter call_partner_as" name="call_partner_as" value="{{$eventsetting['call_partner_as']}}" required>
						...
						<div class="form-group">
							...
							<div class="col-md-9">
								<input type="text" class="form-control" id="call_participant_as" placeholder="Enter call_participant_as" name="call_participant_as" value="{{$eventsetting['call_participant_as']}}" required>
						...
						<input type="hidden"  name="event_id" value="{{$eventsetting['event_id']}}" >
