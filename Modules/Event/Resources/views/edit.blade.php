...
<div class="row">
  <div class="col-md-6">
    ...
    {{csrf_field()}}
      ...
      <div class="form-group{{ $errors->has('if_paid') ? ' has-error' : '' }}">
        <label class="control-label col-sm-4" for="if_paid">If Paid:</label>
        <?php 
          //echo $event['status'];
            $option1 = '';
            $option2 = ''; 
             if($event['if_paid']=='free'){
                $option1 = 'checked';
              }elseif($event['if_paid']=='paid'){
                $option2 = 'checked';
              }else{}
        ...
        <div class="col-sm-8">
              <div class="radio">
                  <label><input type="radio" value="free" name="if_paid" {{$option1}}>Free</label>
                </div>
                <div class="radio">
                  <label><input type="radio" value="paid" name="if_paid" {{$option2}}>Paid</label>
                </div>
              
            </div>
          @if ($errors->has('if_paid'))
              <span class="help-block">
                  <strong>{{ $errors->first('if_paid') }}</strong>
              </span>
          @endif
        </div>
